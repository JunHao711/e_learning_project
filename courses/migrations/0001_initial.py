    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('co_instuctors', models.ManyToManyField(blank=True, related_name='courses_lecturer', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contents', to='courses.course')),
            ],
            options={
                'ordering': ['order'],
            },
